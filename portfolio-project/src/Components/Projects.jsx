                        ...
                        <div className='project-content'>
                            ...
                            <div className='row'>
                                ...
                                <div className='layer'>
                                    ...
                                    <p>Developed a BMS for library management for easy borrow and returning of books.Librarian can add new books to allow easy access to readers</p>
                                    <div className='anchor'>
                            ...
                            <div className='row'>
                                ...
                                <div className='layer'>
                                    ...
                                    <p>Developed to view the property to be in sale and rent for easy way to access to our nearest locations</p>
                                    <div className='anchor'>
